...
public class FIFA04 {
  public static void main(String[] args) {
    ...
    System.out.println("Several players have got 68 Crossing");
    table.stream().filter(fifa -> fifa.getCrossing() == 84)
        .forEach(System.out::println);

    System.out.println();
    System.out.println("Players who got 82 LongShots");
    table.stream().filter(fifa -> fifa.getLongShots() == 82)
        .forEach(System.out::println);
